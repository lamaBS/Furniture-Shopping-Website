...
$coon=mysqli_select_db($conn,"fortuners");
          $sql = "SELECT * FROM product WHERE sold >0 ORDER BY sold DESC ;";
...
if($resultCheck>0){
  ...
  echo "<tr><th>&nbsp; &nbsp;Product ID&nbsp; &nbsp; </th><th>&nbsp; &nbsp;name&nbsp; &nbsp; </th><th>&nbsp; &nbsp;price &nbsp; &nbsp; </th><th> &nbsp; &nbsp; average Raiting &nbsp; &nbsp;</th><th> &nbsp; &nbsp; sold &nbsp; &nbsp;</th></tr>";
while($row=mysqli_fetch_assoc($result)){
echo "<tr>";
echo "<td>&nbsp; &nbsp;".$row['productNo']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['Name']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['price']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['avgRate']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['sold']."&nbsp; &nbsp;</td>";
echo "</tr>";
}
echo "</table>";
}?>
