    ...
    <li id="2"><a data-toggle="tab" style="font-size:20px;" href="sittingEmail.php">Email</a></li>
     <li id="3"><a data-toggle="tab"  style="font-size:20px;" href="sittingPhone.php">PhoneNumber</a></li>
      <li id="3"><a data-toggle="tab"  style="font-size:20px;" href="sittingName.php">Name Change </a></li>
                ...
                <form method="post" action="sittingEmail.php"><br>
                <br>
...
$sqlCheck2 = "SELECT  Email  FROM  admin  WHERE 1 ;";
...
$check2 = $row2['Email'];
                 echo"<input type='text' value=' &nbsp;$check2' size='35%' style='background-color:#F6F6F6;' readonly>"?>
                  <br><br>
                  <label>Please Enter New Email :</label><br>
                  <input type="text" value="" name="new" size="35%"  required>
                  <br><br>
                  <label>Please reEnter New Email :</label><br>
...
$newEmail = $_POST["new"];
$newreEmail = $_POST["renew"];
 if($newEmail !== $newreEmail)
    die("<p style='color:red; font-size:20px;'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;The Emailes you enter are not matching!</p>") ;

$sql = "UPDATE admin SET Email ='$newEmail' WHERE 1;";
$result = mysqli_query($conn,$sql);

if($result){

  echo "<p style='color:red; font-size:20px;'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; The Email is Updated</p> ";
}
else {die("Error !! ");}
