...
$coon=mysqli_select_db($conn,"fortuners");
          $sql = "SELECT * FROM product WHERE refunded >0 ORDER BY refunded DESC LIMIT 8;";
...
if($resultCheck>0){
  ...
  echo "<tr><th>&nbsp; &nbsp;Product ID&nbsp; &nbsp; </th><th>&nbsp; &nbsp;Name &nbsp; &nbsp;</th><th>&nbsp; &nbsp;Orignal price &nbsp; &nbsp; </th><th>&nbsp; &nbsp;price &nbsp; &nbsp; </th><th> &nbsp; &nbsp; average Raiting &nbsp; &nbsp;</th><th> &nbsp; &nbsp; refunded &nbsp; &nbsp;</th></tr>";
while($row=mysqli_fetch_assoc($result)){
echo "<tr>";
echo "<td>&nbsp; &nbsp;".$row['productNo']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['Name']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['orgPrice']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['price']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['avgRate']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['refunded']."&nbsp; &nbsp;</td>";
echo "</tr>";
}
echo "</table>";
}?>
  <h5>*NOTE: this is just the most 8 refunded product , to see all the refunded click <a href="refunded.php">here</a></h5>              
					<br>
				<br>
<div style="color:#cc9900; font-size:28px;">Best Selling Product</div>					
					
				<br><?php
				$sql = "SELECT * FROM product WHERE sold >0 ORDER BY sold DESC LIMIT 8 ;";
          $result = mysqli_query($conn, $sql);
 if (!$result) {
    die(mysqli_error($conn));
}  $resultCheck= mysqli_num_rows($result);
if($resultCheck>0){
  echo "<table id='t2' width='860' >";
  echo "<tr><th>&nbsp; &nbsp;Product ID&nbsp; &nbsp; </th><th>&nbsp; &nbsp;Name &nbsp; &nbsp; </th><th>&nbsp; &nbsp;Orignal price&nbsp; &nbsp; </th><th>&nbsp; &nbsp;price &nbsp; &nbsp; </th><th> &nbsp; &nbsp; average Raiting &nbsp; &nbsp;</th><th> &nbsp; &nbsp; sold &nbsp; &nbsp;</th></tr>";
while($row=mysqli_fetch_assoc($result)){
echo "<tr>";
echo "<td>&nbsp; &nbsp;".$row['productNo']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['Name']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['orgPrice']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['price']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['avgRate']."&nbsp; &nbsp;</td><td>&nbsp; &nbsp;".$row['sold']."&nbsp; &nbsp;</td>";
echo "</tr>";
}
echo "</table>";
}?>
  <h5>*NOTE: this is just the most 8 best selling product , to see all the reorted click <a href="bestSelling.php">here</a></h5>     
				<br>
				<br>
				<br>
                </div>
